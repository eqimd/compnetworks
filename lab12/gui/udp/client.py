...
class MyWindow:
    ...
    def send_packets(self):
        ...
        sock.settimeout(1)
        sock.sendto(self.t_packets.get().encode('utf-8'), (self.t_ip.get(), int(self.t_port.get())))
        for i in range(int(self.t_packets.get())):
            ...
            sock.sendto(msg.encode('utf-8'), (self.t_ip.get(), int(self.t_port.get())))
        sock.close()


window=Tk()
mywin=MyWindow(window)
window.title('Отправитель UDP')
